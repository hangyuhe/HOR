...
<body>
    ...
    <div>
        ...
        <asp:Label ID="Label1" runat="server" Font-Bold="True" style="z-index: 1; left: 203px; top: 34px; position: absolute; height: 40px; width: 110px" Text="Label"></asp:Label>
        ...
        <asp:TextBox ID="TextBox3" runat="server" style="z-index: 1; left: 193px; top: 179px; position: absolute; height: 45px; width: 570px"></asp:TextBox>
        <asp:Button ID="Button1" runat="server" style="z-index: 1; left: 374px; top: 262px; position: absolute" Text="修改医院信息" OnClick="Button1_Click" />
