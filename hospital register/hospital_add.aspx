...
<body>
    ...
    <div>
        ...
        <asp:Label ID="Label5" runat="server" style="z-index: 1; left: 149px; top: 278px; position: absolute" Text="管理员账号"></asp:Label>
        <asp:Label ID="Label6" runat="server" style="z-index: 1; left: 146px; top: 325px; position: absolute" Text="管理员密码"></asp:Label>
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" style="z-index: 1; left: 688px; top: 306px; position: absolute" Text="添加医院" />
