<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/hospital_register.Master" CodeBehind="admin_log in.aspx.cs" Inherits="hospital_register.admin_log_in" %>
    ...
    <asp:content runat="server" ContentPlaceHolderID ="ContentPlaceHolder1">
        ...
        <table class="auto-style8" style="right: 0px; left: 0px; clip: rect(auto, 0px, auto, 0px)" width = "100%">
            <tr>
                ...
                <td>
                    <asp:Label ID="Label_page_signin_name" runat="server" Text="管理员登录" Font-Bold="False" Font-Names="华文仿宋" Font-Size="XX-Large"></asp:Label>
                </td>
            </tr>
        </table>
    </asp:content>
